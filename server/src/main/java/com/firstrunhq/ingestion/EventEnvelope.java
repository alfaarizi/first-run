 ...
 * skew {@code sent_at} reveals. Serialized snake_case, keyed by the hex SHA-256 of {@code
 * tenant_id:end_user_hash} so one user's events stay ordered within a partition.
 */
